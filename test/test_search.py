...
from girder.utility.search import SearchRegistry, searchRegistry
...
@pytest.fixture
def emptySearchRegistry(app):
    searchRegistry.init_app(app)


@pytest.mark.dbFixture('test_search.yml')
def testSearchModeRegistry(server, app, emptySearchRegistry):
    ...
    searchRegistry.addSearchMode('testSearch', testSearchHandler)
    ...
    searchRegistry.removeSearchMode('testSearch')
